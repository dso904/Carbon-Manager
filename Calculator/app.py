...
background = get_base64("./media/background-main.png")
...
left, middle, right = st.columns([1.7,3.5,1.7])
...
tab_result.markdown(f"""You owe nature <b>{tree_count}</b> tree{'s' if tree_count > 1 else ''} this month. <br> {f"<a href='https://www.tatapower.com/green-community/tree-mittra' id = 'button-17' class='button-17' role='button'> 🌳 Let's Do it Myself ! 🌳</a><br><br><b>OR</b><br><br><a href='https://sankalptaru.org' id = 'button-17' class='button-17' role='button'> 🌳 Let NGOs Plant For Me! 🌳</a><br><br>💭You can also chat with our AI Chatbot, Chat2Eco with your data to reduce your carbon footprint and get more assistance regarding sustainability through its plugin at the bottom-right corner.💭<br><br>OR<br><br><a href='https://chat2eco.onrender.com' id = 'button-17' class='button-17' role='button'>💭Chat with Chat2Eco UI💭</a><br><br><a href='https://forms.office.com/r/LK3yU2FZpU' id = 'button-17' class='button-17' role='button'>👣Send My Report & Offset Proof👣</a><br><br><a href='https://forms.office.com/r/6YsqJ3UQ6L' id = 'button-17' class='button-17' role='button'>📈Report Correction Factor📉</a><br><br><a href='https://appdevelopersagnik.wixsite.com/carbon-manager-forum' id = 'button-17' class='button-17' role='button'>💬Carbon Mananger-Forum💬</a><br>" if tree_count > 0 else ""}""",  unsafe_allow_html=True)
